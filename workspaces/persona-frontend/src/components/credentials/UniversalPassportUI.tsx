...
import { 
  ...
  Passport, Star, Trophy, Clock, MapPin, CreditCard, Briefcase,
  ChevronRight, Plus, Settings, Download, Share2, Verified, Sparkles
} from 'lucide-react'
  ...
  return (
    <div className=\"space-y-8\">
          ...
          <div className=\"flex items-center space-x-6\">
            <div className=\"relative\">
              <div className={`w-20 h-20 rounded-full bg-gradient-to-br ${
                ...
                <Passport className=\"w-8 h-8 text-white\" />
              </div>
              {did && (
      ...
      <div className=\"flex space-x-1 bg-gray-800/50 p-1 rounded-xl\">
        {[
          { id: 'passport', name: 'Passport Overview', icon: Passport },
